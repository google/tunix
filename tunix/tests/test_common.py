...
def batch_templatize(self, prompts: List[str], huggingface_tokenizer: Any):
  """Use huggingface tokenizer to batch templatize the prompts."""
  out = []
  for p in prompts:
    out.append(
...
def validate_llm_outputs(expected_output_pattern: List[Tuple(str, List[str])], serving_outputs: List[str]):
