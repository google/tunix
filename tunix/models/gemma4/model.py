...
# Public import path tunix.models.gemma4.model is kept byte-for-byte stable;
# ~45 callers do `import model as model_lib` and model_test reaches privates.
# pylint: disable=g-multiple-import,unused-import

# Keep submodules importable AND available as model.audio / model.vision / model.moe.
...
# FeedForward, DecoderLayer, Gemma4 remain DEFINED below in this file.
