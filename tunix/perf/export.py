...
class PerfMetricsExport:
  ...
  def from_cluster_config(
    ...
    trace_writer = None
    # Enable trace writer by default if options is None.
    if perf_metrics_options and perf_metrics_options.enable_trace_writer:
      export_dir = (
          perf_metrics_options.log_dir or None
      )  # In None case, trace writer will use default directory.
