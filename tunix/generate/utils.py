...
def padded_fill_tokens_and_logits(
  ...
  """Pads the output tokens and logits to the maximum length.

  For the token_buffers, find the index of the first non_pad token and use
  it to copy over the generated results to output_tokens and output_logits.
