  ...
  def apply_chat_template(
    ...
    if self._tokenizer_type == TokenizerType.HF:
      ...
      raise NotImplementedError(
          'The `apply_chat_template` method is only supported for '
          'HuggingFace tokenizers in the current implementation.'
      )
    else:
      ...
      raise NotImplementedError(
          f'Tokenizer of type {self._tokenizer_type} does not support '
