...
def _parse_args(argv: list[str]) -> argparse.Namespace:
  ...
  parser.add_argument(
      ...
      default=None,
      help=(
          "Trajectories per trainer forward pass. Defaults to 4 * "
          "num_generations, matching the agentic recipe's four prompt groups."
      ),
  )
  ...
  parser.add_argument(
      ...
      default=weight_sync.WeightSyncMode(os.getenv("WEIGHT_SYNC_MODE", "raiden")),
  ...
  if args.train_micro_batch_size is None:
    args.train_micro_batch_size = 4 * args.num_generations
