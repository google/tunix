...
def create_dataset(
  ...
  # Keep the data module lazy: it imports Grain/TensorFlow, while this registry
  # module is also loaded by the TPU rollout process before vLLM. Importing the
  # data stack there can initialize another XLA runtime before vLLM's TPU
  # backend and crash the process at native-library load time.
