...
# ==============================================================================
# Recipe: Qwen3.5-35B-A3B Distributed FrozenLake (256 Concurrency / 128 TPU Chips)
# ==============================================================================
# Architecture:
...
# - Multiturn: Gym FrozenLake environment loop with up to 8 conversation turns,
#   in-process task rewards, and token-level action masking.
# ==============================================================================
...
export WANDB_RUN_NAME="${WANDB_RUN_NAME:-${JOB_PREFIX}-frozenlake-35b-256}"
...
# ==============================================================================
# FrozenLake Multiturn Environment & Sequence Parameters
# ==============================================================================
...
# Rollout Registry & Agent configuration
...
# ==============================================================================
# Execution Dispatch to frozenlake_dist Launcher
# ==============================================================================
if [ -f "${DIR}/../frozenlake_dist/k8s_launcher.sh" ]; then
  LAUNCHER="${DIR}/../frozenlake_dist/k8s_launcher.sh"
elif [ -f "${DIR}/tunix/experimental/examples/frozenlake_dist/k8s_launcher.sh" ]; then
  LAUNCHER="${DIR}/tunix/experimental/examples/frozenlake_dist/k8s_launcher.sh"
elif [ -f "${DIR}/../../../../third_party/py/tunix/experimental/examples/frozenlake_dist/k8s_launcher.sh" ]; then
  LAUNCHER="${DIR}/../../../../third_party/py/tunix/experimental/examples/frozenlake_dist/k8s_launcher.sh"
elif [ -f "${HOME}/github/tunix_build/tunix/experimental/examples/frozenlake_dist/k8s_launcher.sh" ]; then
  LAUNCHER="${HOME}/github/tunix_build/tunix/experimental/examples/frozenlake_dist/k8s_launcher.sh"
else
  echo "Error: frozenlake_dist/k8s_launcher.sh not found relative to ${DIR}"
  exit 1
fi
