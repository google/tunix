...
export TUNIX_IMAGE="${TUNIX_IMAGE:-gcr.io/cloud-tpu-multipod-dev/niting/trellis-397b:latest}"
...
export ROLLOUT_MESH_EXPERT="${ROLLOUT_MESH_EXPERT:-16}"
...
export RPC_TIMEOUT_S=10800
export ORCHESTRATOR_EXTRA_ENV="WEIGHT_SYNC_TRANSFER_TIMEOUT_S=10800 WEIGHT_SYNC_H2D_TIMEOUT_S=1800 RAIDEN_PARALLELISM=16 TPU_RAIDEN_DATA_NICS=eth0 RAIDEN_BROADCAST_K=3"
export ROLLOUT_EXTRA_ENV="RAY_memory_monitor_refresh_ms=0 RAIDEN_TRANSPORT_COALESCE_WINDOW_BYTES=67108864 RAIDEN_WEIGHT_SYNC_PIPELINE_GROUP_SIZE=16 RAIDEN_PARALLELISM=16 ENABLE_MULTI_NUMA=1 TPU_RAIDEN_DATA_NICS=eth0 RAIDEN_BROADCAST_K=3"
export TRAINER_LIBTPU_INIT_ARGS="--DANGEROUS_tpu_runtime_abi_verification_disabled=true --xla_tpu_use_tc_device_shape_on_sc=true --xla_sc_disable_megacore_partitioning=true --xla_tpu_enable_offloading_gather_to_sparsecore=true --xla_tpu_enable_sparse_core_collective_offload_all_gather=true --xla_tpu_enable_sparse_core_collective_offload_2d_all_gather=true --xla_tpu_enable_sparse_core_collective_offload_reduce_scatter=true --xla_tpu_enable_sparse_core_reduce_scatter_v2=true --xla_tpu_use_single_sparse_core_for_all_gather_offload=false --xla_tpu_enable_concurrent_sparse_core_offloading=true --xla_tpu_aggressive_opt_barrier_removal=true --xla_tpu_scoped_vmem_limit_kib=65536 --xla_tpu_enable_sublane_major_scaling_bitcast_fusion=false"
export TRAINER_EXTRA_ENV="RAIDEN_TRANSPORT_COALESCE_WINDOW_BYTES=67108864 RAIDEN_WEIGHT_SYNC_PIPELINE_GROUP_SIZE=16 ENABLE_MULTI_NUMA=1 TPU_RAIDEN_DATA_NICS=eth0 RAIDEN_BROADCAST_K=3 LIBTPU_INIT_ARGS='${TRAINER_LIBTPU_INIT_ARGS}'"
export PATHWAYS_WORKER_EXTRA_ENV="LIBTPU_INIT_ARGS=${TRAINER_LIBTPU_INIT_ARGS} --megascale_port=-1 --xprof_compress_jftrace=true
