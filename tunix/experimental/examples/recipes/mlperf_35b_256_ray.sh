...
export CLUSTER_NAME="bodaborg-v5p-nap"
...
export PATHWAYS_SERVER_IMAGE="us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/gke/datenglin/unsanitized_server:raiden_20260919_cl982970702"
export PATHWAYS_PROXY_IMAGE="us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/gke/datenglin/unsanitized_proxy_server:raiden_20260919_cl982970702"
...
# Topologies (64 chips Trainer 4x4x4, 8x 8-chip Rollout slices with Ray backend)
...
export ROLLOUT_JOBSET_YAML="jobset.ray.yaml"
