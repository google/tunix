...
export MAXTEXT_OUTPUT_DIR=${MAXTEXT_OUTPUT_DIR:-artifacts/deepswe_mlperf/maxtext}
  ...
  "$PYTHON" tunix/experimental/distributed/deployment/yaml_generator.py \
    ...
    --worker_startup_command=" \
      ...
      python -m tunix.experimental.distributed.runtime.main \
        ...
        --process_main=tunix.experimental.examples.deepswe_mlperf.run_deepswe_dist.main \
        --model_id=${MODEL_ID} \
  ...
  "$PYTHON" tunix/experimental/distributed/deployment/yaml_generator.py \
    ...
    --worker_startup_command=" \
      SKIP_JAX_PRECOMPILE=1 VERIFY_WEIGHTS=${VERIFY_WEIGHTS} ${sandbox_env} ${ROLLOUT_USE_BATCHED_RPA:+USE_BATCHED_RPA_KERNEL=1} python -m tunix.experimental.distributed.runtime.main \
        ...
        --lora_alpha=${LORA_ALPHA} \
        --weight_sync_mode=${WEIGHT_SYNC_MODE} \
        --registry_module=tunix.experimental.examples.deepswe_mlperf.deepswe \
