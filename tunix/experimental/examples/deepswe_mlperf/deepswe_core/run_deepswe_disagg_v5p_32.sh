...
python -m tunix.cli.grpo_main \
  ...
  \
  `# ── Data ─────────────────────────────────────────────────────────────` \
  data_module="tunix.experimental.examples.deepswe_mlperf.deepswe_core.deepswe_data" \
  ...
  agent_class_path="tunix.experimental.examples.deepswe_mlperf.deepswe_core.swe_agent.SWEAgent" \
  env_class_path="tunix.experimental.examples.deepswe_mlperf.deepswe_core.swe_env.SWEEnv" \
