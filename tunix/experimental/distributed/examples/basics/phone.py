...
def main(argv: list[str], context: ProcessContext | None) -> None:
  ...
  parser.add_argument("--message", type=str, default="this is phone!", help="")
  ...
  client = context.ipc.discovery.connect(
      ...
      on_connected=lambda epoch, is_rec: logging.info(
          f"Connected (epoch: {epoch})"
      ),
      on_disconnected=lambda epoch, reason: logging.warning(
