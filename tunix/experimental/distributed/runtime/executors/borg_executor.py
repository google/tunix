...
"""Borg and direct execution distributed runtime process executor."""
...
class BorgExecutor:
  """Process executor that runs a target main function inside a Borg runtime context."""
  ...
  def run(
    ...
    """Executes `process_main` inside a `BorgProcessContext`.
    ...
    """
    with BorgProcessContext(context_args) as context:
