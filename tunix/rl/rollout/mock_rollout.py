...
class MockRollout(base_rollout.BaseRollout):
  ...
  Kwargs:
    ...
    length_mean (float): Mean for the length distribution. This is an optional,
    ...
    length_std (float): Standard deviation for the length distribution. This is
      an optional, since reasonable defaults are provided for each distribution
      mode.
  """
