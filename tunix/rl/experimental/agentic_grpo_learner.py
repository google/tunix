...
class GRPOLearner(rl_learner.RLLearner):
  ...
  def _make_agent_env_pair(
    ...
    # TODO(haoyugao): b/456528861 - Support both single-turn and multi-turn from config.
  ...
  def _process_results_and_compute_advantage(
    ...
    # TODO(haoyugao): b/456528861 - Refactor reward computation to happen within the
