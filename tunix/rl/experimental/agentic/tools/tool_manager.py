...
class ToolManager:
    ...
    compatibility with both OpenAI function calling and MCP (Model Context Protocol)
    standards, etc.
    """
    ...
    def __init__(self, tool_map: Dict[str, Type[BaseTool]], *, desc_fallback: str = ""):
        ...
        Args:
            tool_map (Dict[str, Type[BaseTool]]): Mapping of tool names to their
                implementation classes. Each class will be instantiated once
                and reused for all calls.
            desc_fallback (str): Default description used when a tool class
                lacks a docstring. Helps maintain consistent documentation.
        """
    ...
    def execute_calls(self, calls: List[ToolCall], parallel: bool = True) -> Dict[str, str]:
        ...
        Returns:
            Dict[str, str]: Mapping from call IDs to string-formatted tool outputs.
                Call IDs are taken from the ToolCall objects or generated if missing.
        """
        outputs = {}
