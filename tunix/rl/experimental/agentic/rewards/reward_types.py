...
class RewardOutput:
    ...
    Attributes:
        reward (float): The numerical reward signal for the agent's action.
            This is the primary value used by RL algorithms for learning.
            Positive values indicate good performance, negative values indicate
            poor performance, and zero typically represents neutral outcomes.
        metadata (Dict[str, Any]): Additional information about the reward computation.
            Can include intermediate scores, detailed breakdowns, confidence measures,
            error messages, timing information, or any diagnostic data useful for
            analysis and debugging. Default is an empty dictionary.
