...
class AgenticRLLearner(abc.ABC, Generic[TConfig]):
  ...
  def _model_call(
    ...
    if prompt_token_ids is None:
      ...
      prompts, token_kwargs = [chat_lists], {}
    else:  # exact token continuity: the recorded history is the prompt
      prompts, token_kwargs = None, {
    ...
    result = self.rl_engine.generate(
        ...
        apply_chat_template=not (self.chat_parser or token_kwargs),
