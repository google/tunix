...
class Step:
  ...
  Attributes:
    ...
    routed_experts: `[len(assistant_tokens), num_layers, top_k]` MoE expert ids
      the rollout routed this step's tokens through, or None when the sampler
      captured none. Positions with no capture carry
