...
class Step:
  ...
  Attributes:
    ...
    topk_token_ids: Top-k token IDs for assistant tokens [length, top_k], or
      None.
    topk_logprobs: Top-k log probabilities for assistant tokens [length, top_k],
      or None.
  ...
  topk_token_ids: Optional[np.ndarray] = None
