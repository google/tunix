...
class Step:
  ...
  Attributes:
    ...
    assistant_routed_experts: Per-token routed expert IDs for assistant tokens [length, num_layers, top_k], or None.
    env_routed_experts: Per-token routed expert IDs for environment observation tokens [length, num_layers, top_k], or None.
  """
