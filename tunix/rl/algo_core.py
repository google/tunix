...
def ppo_policy_loss_fn(
  ...
  pg_losses_2 = -jnp.clip(seq_importance_ratio, 1 - epsilon_low, 1 + epsilon_high) * advantages
...
def compute_drgrpo_advantages(rewards: jax.Array, num_generations: int) -> jax.Array:
