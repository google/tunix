...
| CANON_P67_P66_VMA_P59_ONLY | P67 FrozenLake TP8 serving 程序同一性修复：当 P66 checked-VMA 进程级 alias 开启时，只允许精确 P59 outer manual `data/model` pullback 消费 pcast/Pallas out-shape/RPA out-shape/embed invariant 登记；ordinary serving decode/prefill 保持历史图。它不关闭 P59 backward 修复，不改变数学值或 fixed TP reduction order | 0/off；`CANON_V1_FL_TP8_AB_ARM=serving-scope` 诊断，或精确 P45-readiness/M15-main、DP8×TP8、strict zero、300-update FrozenLake V1 full profile可设 1；GSM8K 与其他 profile 禁止 | host Phase4/P57/P59/P66/APC 与 flags、固定镜像 installed DP2×TP4/TP8 focused/full gate已绿；Wave 5 real P45 DP8×TP8 serving-scope 为 48,594 action tokens、depth 2,472、A−B/B−C strict `0/0`、zero backward/commit。P45 serving recovery已验证；M15 serving、两负载 full backward/AdamW/perf/convergence 未验证 | P45/M15 各自300-update full horizon、首commit backward-health与 strict Zero-TIM 全绿后按 workload 转正；任一红退回诊断并保留证据 |
