...
| V1.P4.10 | Localize the post-P66 FrozenLake TP8 forward regression with a production-geometry, pre-backward matched pair | P45 p66-off vs serving-scope render/resolved-env; finite A−B, exact B−C, depth floor, controlled zero-commit exit; scoped TP4/TP8 P59 and full pinned-image before publication | active; both arms host/full-image green, target not run |
