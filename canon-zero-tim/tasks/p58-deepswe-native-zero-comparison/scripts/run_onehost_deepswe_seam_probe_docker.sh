...
sudo docker run --rm --privileged --net=host --ipc=host --uts=host \
  ...
  ${CANON_ENTROPY_VJP:+-e CANON_ENTROPY_VJP=$CANON_ENTROPY_VJP} \
  ${CANON_LOGPROB_VJP_KERNEL:+-e CANON_LOGPROB_VJP_KERNEL=$CANON_LOGPROB_VJP_KERNEL} \
  ${CANON_RPA_VJP_BLOCKWISE:+-e CANON_RPA_VJP_BLOCKWISE=$CANON_RPA_VJP_BLOCKWISE} \
  ...
  ${CANON_PALLAS_MATMUL_TILES:+-e CANON_PALLAS_MATMUL_TILES=$CANON_PALLAS_MATMUL_TILES} \
  ${CANON_PALLAS_RMSNORM_TILES:+-e CANON_PALLAS_RMSNORM_TILES=$CANON_PALLAS_RMSNORM_TILES} \
  "$image" \
  bash -euo pipefail -c '
