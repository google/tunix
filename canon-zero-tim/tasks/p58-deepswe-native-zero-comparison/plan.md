...
P58.7 remains deferred. The user selected Native-IS as the next target; P58.9
source is published and read back. Target execution begins only after the
exact Native-raw archival boundary and final render/admission checks.
