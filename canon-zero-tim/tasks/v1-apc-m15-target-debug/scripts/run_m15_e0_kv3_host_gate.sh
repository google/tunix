...
python3 -m py_compile \
  ...
  tunix/rl/agentic/token_continuity.py \
  ...
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/classify_m15_apc_debug_tito.py \
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/classify_m15_e0v_onehost_arm.py \
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/classify_m15_e0v_onehost_pair.py \
  ...
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/test_classify_m15_apc_debug_tito.py \
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/test_classify_m15_e0v_onehost_arm.py \
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/test_classify_m15_e0v_onehost_pair.py \
...
bash -n \
  ...
  canon-zero-tim/tasks/v1-apc-m15-target-debug/scripts/prepare_m15_e0v_tito_layer_pair.sh \
