...
- Next action after an explicitly approved publication: raise or bypass legacy incident byte bound in 90_run.sh and launch fresh Attempt 12 (`d18`) to localize the First-Red Layer.
- Claim ceiling: `ATTEMPT11_TARGET_RUN_COMPLETED / HIT_RATE_93_1_CONFIRMED / CLASSIFICATION_JSON_LEDGER_BOUNDED`.
...
- Updated: 2026-08-27 (Attempt 11 d17 completed on 64 TPUs; 93.1% hit rate confirmed).
