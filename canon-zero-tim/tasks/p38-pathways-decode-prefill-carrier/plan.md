...
| P38.2g5 | Request-anchored serving trigger and red-safe diagnostic stop | The installed runner attests module initialization and bounded scheduler-prefix observations, four request-anchored records survive, finite A-B red with exact B-C stops before backward, and outer postflight returns the real capsule/archive | published at `02e8c05d`; P38s6 target run pending |
