...
| P38.2l | Incident-durable terminal capture | Mid-run immutable GCS snapshots, all-red-row incident joins, pinned-image dress rehearsal, instrumentation freeze, then one source-pinned stock P38s15 payload | implementation published at `bd309015`; P38s13a/s14 used old sources; P38s15 NOT RUN |
