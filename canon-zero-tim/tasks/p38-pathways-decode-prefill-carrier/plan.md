...
| P38.2x | Dedicated fixed-tile Pallas lm-head | Remove the M16/M256 local lm-head program freedom with M256/K4096/N38144 fixed tiles, first on real-weight one-host and then in one three-round P38s23 target | local gates pass; P38s23 renderer/runbook ready, target not launched |
