...
| P38.2m | Fixed-M single-active discriminator | Natural single-active incident records retain production padded aval/sharding and exact tokens; shape-one substitution and device fetch fail closed; DP1 replay is labeled E0-lite | locally complete; publication approved; target evidence pending |
