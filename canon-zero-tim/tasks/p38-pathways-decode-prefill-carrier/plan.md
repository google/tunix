...
| P38.2o | Evidence reconciliation and decode seam walk | Classification is input-SHA reproducible, invalid tails are masked, every observer pair joins a red round, and observer-neutral hierarchical production runs name the first divergent layer then internal checkpoint | O0/O1 locally complete; O2a layer target pending review/publication, no launch from this worktree |
