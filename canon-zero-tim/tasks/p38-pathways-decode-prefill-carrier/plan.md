...
| P38.2q | One-pass snapshot selection, duplicate-row audit, and self-contained reduction bundle | Two completed capsule rounds are selected automatically; aliases require numerical identity; conflicts retain every raw candidate; standalone bundle audit reproduces the classifier without GCS | local implementation and focused gates complete; GCP v2 execution pending publication |
