...
| P38.2x | Dedicated fixed-tile Pallas lm-head | Remove request-bucket lm-head program freedom with M256/K4096/N38144 fixed tiles, first on real-weight one-host and then in one three-round target | P38s23 warmup exposed omitted M32; P38.2x1 exact buckets M8/16/32/64/128/256 pass 24/24 one-host comparisons; P38s23r1 ready, target not launched |
