...
| P38.2x | Dedicated fixed-tile Pallas lm-head | Remove request/learner lm-head program freedom with one M256/K4096/N38144 body, first on real-weight one-host and then in one three-round target | P38s23r1 passed all request warmups/rollout then exposed learner M4096; P38.2x2 maps it to 16xM256; CPU/exact-image pass, real-v5p pending |
