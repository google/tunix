...
| P38.2v | Bounded-object diagnostic durability | Preserve every logical observer file and SHA while reducing each live snapshot/round to one deterministic archive, one manifest, and one completion-last marker; then finish one three-round P38s21 target | host implementation complete; 5,246-file determinism/corruption gates and fake-GCS three-object live/round transport pass; awaiting user review and publication |
