"""Pinned-image value/target controls for the P58 native B observer."""
...
from tpu_inference.runner import p58_stock_prompt_observer as observer
...
class P58StockPromptObserverTest(unittest.TestCase):

  def test_absolute_targets_do_not_cross_dp_or_request_boundaries(self):
    requests = {
        "a": _Request([11, 12, 13]),
        "b": _Request([21, 22]),
  ...
  def test_end_to_end_keeps_target_identity_and_processed_value(self):
