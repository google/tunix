...
calibration = _module("p57_calibration_renderer", CLUSTER / "render_frozenlake_calibration.py")
paired = _module("p57_paired_renderer", CLUSTER / "render_frozenlake_three_arm.py")
THREE_ARM_WRAPPER = (
    ROOT
    / "canon-zero-tim/workloads/frozenlake-three-arm/scripts"
