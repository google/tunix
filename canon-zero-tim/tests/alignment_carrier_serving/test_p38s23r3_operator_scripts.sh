...
COLLECT="$ROOT/workloads/alignment-carrier/scripts/collect_p38s23r3_return.sh"
ARCHIVE="$ROOT/workloads/alignment-carrier/scripts/p38_evidence_archive.py"
...
cp "$ROOT/tests/alignment_carrier_serving/fake_gcloud.sh" "$tmp/bin/gcloud"
