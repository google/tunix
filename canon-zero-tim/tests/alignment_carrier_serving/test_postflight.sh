...
run_case() (
  ...
  cp "$ROOT/tests/alignment_carrier_serving/fake_gcloud.sh" "$state/bin/gcloud"
  ...
  command="python3 $ROOT/tests/alignment_carrier_serving/make_fixture.py --directory $state/capture --mismatch-capsule $CANON_P38_MISMATCH_CAPSULE"
