...
$docker run --rm \
  ...
  bash -euo pipefail -c '
    ...
    echo "V1_HP_EXACT_IMAGE_PASS dp16_gathered=1 dp2tp2_parallel=2 p59_tp4_tp8=2 p59_real_shim=4 p59_rpa=2 p59_fused_linear=2 p62_numeric=6 p57_wandb=1 m15_token=1 apc_m15_carrier=35 perfetto_window=1 manifests=3"
  '
