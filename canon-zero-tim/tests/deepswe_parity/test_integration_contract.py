...
class P44IntegrationContractTest(unittest.TestCase):
  ...
  def test_onehost_is_shared_dp1_tp4_docker_and_default_off(self):
    ...
    runner = (
        ROOT
        / "canon-zero-tim/tests/deepswe_parity/"
  ...
  def test_postflight_routes_p44_before_existing_deepswe_lanes(self):
    ...
    p44 = text.index(
        "tests/deepswe_parity/classify_run.py"
    )
    p43 = text.index("tests/deepswe_debug/classify_run.py", p44)
    p39 = text.index("tests/deepswe_pilot/classify_run.py", p43)
    p34 = text.index("tests/deepswe/classify_run.py", p39)
