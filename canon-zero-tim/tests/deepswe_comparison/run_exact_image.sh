...
bash "$ROOT/canon-zero-tim/tests/deepswe_parity/run_exact_image.sh" \
  "$IMAGE"
bash "$ROOT/canon-zero-tim/tests/parallel_backward/run_tp4_tp8_installed_shim_exact_image.sh" \
  "$IMAGE"
...
$DOCKER run --rm \
  ...
  bash -euo pipefail -c '
    bash -n \
      ...
      canon-zero-tim/tests/deepswe_comparison/run_onehost_alignment_v5p.sh \
      canon-zero-tim/cluster/steps/p58_verify_sandbox_capacity.sh \
      canon-zero-tim/cluster/steps/p58_verify_head_pvc_probe.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_xprof_common.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_xprof_native.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_xprof_zero_hp.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_seam_probe.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_seam_probe_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_admission.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_admission_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_standard_decode.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_standard_decode_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_continue_kv.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_continue_kv_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_short_backward.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_short_backward_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_carrier_screen.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_carrier_screen_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_trajectory_replay.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_trajectory_replay_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/run_onehost_deepswe_zero_p78_actor_logps_docker.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/prepare_p58_checked_vma_off_diagnostic.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/prepare_p58_checked_vma_aba_wave.sh \
      canon-zero-tim/workloads/deepswe-comparison/scripts/prepare_p58_coarse_seam_localization.sh \
      canon-zero-tim/workloads/workload-rollout/prepare_deepswe_zero_hp_full.sh \
    ...
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_loss_contract.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_renderer.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_profile.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_sampler_recipe.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_alignment_policy.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_environment_contract.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_sandbox_capacity_probe.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_artifacts.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_classifier.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_stock_prompt_observer.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_onehost_xprof.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_onehost_xprof_pair.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_decode_prefill_probe.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_qwen4b_tp4_zero_contract.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_continue_kv_probe.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_short_carrier_screen.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_trajectory_replay.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_checked_vma_diagnostic.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_checked_vma_aba_wave.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_zero_hp_full_classifier.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/test_coarse_seam_classifier.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/full_recipes/test_first_update_gate.py
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/full_recipes/test_stable_clip_contract.py
    PYTHONPATH=/workspace python3 -m unittest discover \
      -s canon-zero-tim/tests/prefix_cache \
      -p "test_*.py"
    (
      cd tests/rl
    ...
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_parity/test_renderer.py
    (
      cd tests/rl
      PYTHONPATH=/workspace python3 -m unittest \
    ...
    PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/probe_continue_decode_observer_overlay.py \
    ...
    CANON_P58_Q4_TP4_CONTINUE_KV_DIAGNOSTIC=1 \
      ...
      PYTHONPATH=/workspace python3 \
      canon-zero-tim/tests/deepswe_comparison/probe_continue_kv_overlay.py \
    ...
    env PATHWAYS_HEAD="" JAX_BACKEND_TARGET="" JAX_PLATFORMS=cpu \
      python3 \
      canon-zero-tim/tests/deepswe_comparison/probe_stock_prompt_observer.py
    rm -r "$observer_state"
