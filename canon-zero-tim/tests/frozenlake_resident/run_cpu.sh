...
'canon-zero-tim/cluster/render_jobsets.py',\
'canon-zero-tim/cluster/render_frozenlake_resident.py',\
...
'canon-zero-tim/tests/frozenlake_resident/test_host_memory.py',\
'canon-zero-tim/tests/frozenlake_resident/test_renderer.py',\
'canon-zero-tim/tests/frozenlake_resident/test_qwen8b_tp8.py',\
'canon-zero-tim/tests/frozenlake_resident/probe_checkpoint_v5p.py',\
'canon-zero-tim/tests/frozenlake_resident/probe_overlay_import.py',\
'canon-zero-tim/tests/frozenlake_resident/probe_qwen8b_tp8.py'); \
...
bash -n \
  ...
  canon-zero-tim/tests/frozenlake_resident/run_cpu.sh \
  canon-zero-tim/tests/frozenlake_resident/run_exact_image.sh \
  canon-zero-tim/tests/frozenlake_resident/run_onehost_checkpoint_v5p.sh
...
validate_p45_profile() (
  ...
  export CANON_FROZENLAKE_CKPT_TAG=fl-local-gate
...
validate_p45_profile
echo "[P45.FROZENLAKE] CPU_GATE PASS topology=DP8xTP8 optimizer=device-resident checkpoint=every10/latest1"
