...
class P44ContractTest(unittest.TestCase):
  ...
  def test_topologies_share_one_normalized_recipe(self):
    ...
    self.assertEqual(small.model_id, "Qwen/Qwen3-4B-Instruct-2507")
    self.assertEqual(large.model_id, "Qwen/Qwen3-4B-Instruct-2507")
    self.assertEqual(small.max_response_length, 16_384)
    self.assertEqual(large.max_response_length, 16_384)
    self.assertEqual(small.max_turns, 50)
    self.assertEqual(large.max_turns, 50)
    self.assertEqual(small.global_prompts, 4)
    self.assertEqual(large.global_prompts, 4)
    self.assertEqual(small.generations, 4)
    self.assertEqual(large.generations, 4)
    self.assertEqual(small.max_steps, 3)
    self.assertEqual(large.max_steps, 3)
