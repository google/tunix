...
| 5 | **frozenlake-zero-full** | P4.10 Wave 5 的 P45 p66-off/serving-scope 均 strict A−B/B−C `0/0`；P4.11 已把 P67 仅准入 exact P45/M15 full，host Phase4 89/89、P57 146/146、P59 37/37、P66 16/16、APC 31/31、flags 385/385 与 P67-enabled full exact-image 全绿；发布身份只认 remote-read exact SHA，未 launch | **remote exact SHA clean read-back 后只渲染并并发 launch P45/M15 两个 300-update full，首 commit 硬验 backward-health/AdamW，最终只认完整 postflight** | M15 precheck 已由用户明确 waived，但所有 strict/full gates 保留；full target 未跑 | tasks/v1-phase4-three-full-recipes |
