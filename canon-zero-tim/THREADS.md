...
| 5 | **deepswe-train** | V1 Attempt 3 三份日志已齐：GSM8K/P45 分别在 TP4/TP8 证明 P59 RPA 重复扩展已 local KV，M15 独立暴露签名 4096/8192 被旧 4096/2048 gate 拒绝；本地 `248c5f9d` 修 RPA、`aa84c147` 仅放行注册 M15 width，host V1 21/21、P57 144/144、P59 34/34、APC 31/31、flags 366/366，新增 exact-image 门仍未跑；三个 target 均 0 optimizer commit | **获单独批准跑 P58/V1 pinned-image，要求 `p59_rpa=2 m15_token=1`；绿后 push/readback，再经 launch 批准同时起 GSM8K/P45/M15 三个 full JobSet** | 等 exact-image 执行批准；P58.6 direct pair 与 P58.7 full 仍各自等待单独授权 | tasks/v1-phase4-three-full-recipes |
