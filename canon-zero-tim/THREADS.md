...
> 更新:2026-08-25 @ c87838d8;perf 行 2026-08-25(P60-2F 历史 target + 最新-tip admission)
...
| 2 | **perf** | P60-2F 历史 clean source `5549b5b6` one-host TARGET PASS：3/3 updates、51/51 alignment、same-track `train_step=1` hierarchy、microsteps 0..15/last15/update1、8/8 backward+scaled×16+commit×1、decode absent、ledger 9/9；最新 operator base `a909fda1` 整合为 `c87838d8`，P60/P59/V1/P64 host 与 pinned exact-image 全绿，但未 target 重跑；evidence-only concern 已作为三提交 stack 的第三个 CL 发布 | **若发布口径保持“5549 历史 TARGET PASS、c87838d8 最新整合 exact-image admitted”，无需再烧 TPU；只有要称 c87838d8 为 TARGET PASS 才另批 fresh one-host** | 无；新的 target 或发布动作均需另批 | tasks/v1-gsm8k-onehost-xprof-pair |
