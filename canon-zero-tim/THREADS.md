...
| 5 | **deepswe-train** | P58.6 one-host Native/Zero-HP XProf、P58.7 Qwen3-4B DP8xTP8 Zero-HP full、P58.8 P59 TP4/TP8 mesh/shim repair 已在最新 `ccbcf572` 上拆成四个功能 CL；FP32 TP rank sum 加 operand barrier 后，P59 30/30、P57 136/136、V1 12/12、APC 31/31 及 P58/V1 两个耐久 pinned-image 门全绿；第五个 audit-only CL 排除不可变日志 marker 假 flag 后，完整 registry audit 为 366/366 PASS；真实 target 未跑 | **完成已批准 push 与 exact readback；随后优先 V1 GSM8K full，P58.6 direct pair 与 P58.7 full 继续等待单独授权** | 等 remote readback；随后各硬件动作单独批准 | tasks/p58-deepswe-native-zero-comparison |
