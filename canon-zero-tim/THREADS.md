...
| 5 | **deepswe-train** | P58.6 one-host Native/Zero-HP XProf、P58.7 Qwen3-4B DP8xTP8 Zero-HP full、P58.8 P59 TP4/TP8 mesh/shim repair 已在最新 `ccbcf572` 上拆成四个本地 CL；FP32 TP rank sum 加 operand barrier 后，P59 30/30、P57 136/136、V1 12/12、APC 31/31、flags 366/366 及 P58/V1 两个耐久 pinned-image 门全绿；committed tree 已封存，真实 target 未跑 | **停在本地四-CL 栈等待 push 决策；发布并 exact readback 后先独立 target 认证 P59 TP4/TP8，再按单独授权跑 P58.6 direct pair 与 P58.7 full** | 等 push 批准；随后各硬件动作单独批准 | tasks/p58-deepswe-native-zero-comparison |
