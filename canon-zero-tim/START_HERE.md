...
| P35 three-arm envelope discriminator | **MULTI-CHUNK REPAIR LOCAL; TARGET NOT RUN** — r24 confirmed the response-256 Splash repair but exposed a diagnostic-only one-chunk assumption before B. The repaired producer reconstructs complete multi-chunk B metadata; no 64-chip carrier verdict exists yet. |
