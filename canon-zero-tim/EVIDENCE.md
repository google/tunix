...
| Semantic v2 timeline covers the G6 training phase: peft_train span with nested segmented_value_and_grad / gradient_commit | p55a,p55b,p55c | probe host `p51_gsm8k_xprof_p55{a,b,c}_20260819/` — census 6/6/6 spans each (3 steps × begin/end), 51/51 alignment zero on all three; p55b default-path trace `f7e1a97a083cd92e…` |
