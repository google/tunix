...
Status: **实现完成;TPU gate 阻塞(用户 P31 训练占用设备),非数值 FAIL**
Date: 2026-08-05
...
- 决定第三程序漂移是否出现的变量 = **单次归约的 way 数**(2-way 净 / 4-way 脏),
  与设备总数、mesh 维度、device order 无关(`phase19_bi_kernels.md:2129-2137`)。
  **只测过 2 和 4;8 未知**,而 tp8 是可能的目标宽度。
