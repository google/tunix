...
- [x] **P7 DP16×TP4 bounded admission** — single-slice 64-chip Attempt 0 has clean package
      provenance; P1a passes, generic P1 completes 18/18 as an advisory dirty diagnostic, P1b is
      bitwise with live gradients at all four depths, and same-session toy T2 passes 7/7. This
      admits implementation of the real DP16×TP4 adapter only. The P32 profile remains
      admission-only and does not admit model initialization or training. See `phase4.md`,
      `phase7.md` and `phase8.md`.
