...
ALLOWED_P1_UNTRACKED = frozenset({
    ...
    "canon-zero-tim/workloads/gemma-frozenlake/HANDOFF.md",
    "canon-zero-tim/workloads/gemma-frozenlake/RUNBOOK.md",
    "canon-zero-tim/workloads/gemma-frozenlake/scripts/classify_p1_admission.py",
    "canon-zero-tim/workloads/gemma-frozenlake/scripts/preflight_p1_launch.py",
    "canon-zero-tim/workloads/gemma-frozenlake/scripts/render_p1_onehost_stock_admission.py",
    "canon-zero-tim/workloads/gemma-frozenlake/scripts/run_p1_onehost_stock_admission.sh",
