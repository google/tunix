...
RENDERER_PATH = CANON / "cluster/render_frozenlake_long_horizon_debug.py"
BASE = CANON / "cluster/jobset-64chip.yaml"
SOURCE = "7" * 40
SPEC = importlib.util.spec_from_file_location("render_frozenlake_long_horizon_debug", RENDERER_PATH)
