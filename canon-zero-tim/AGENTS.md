...
| 2 | `.claude/skills/manage-canon-zero-tim-branch/SKILL.md` | how to operate: run contract, gate ladder, flag lifecycle, multi-agent protocol (canonical copy is this in-branch one) |
