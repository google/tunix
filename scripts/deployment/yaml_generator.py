...
def main():
  ...
  parser.add_argument("--tpu_slice", default=None, help="TPU type and tpu_topology (e.g. tpu7x:4x4x8)")
  parser.add_argument("--cpu_machine", default=None, help="CPU machine type (e.g. n2-standard-64)")

  parser.add_argument("--pathways_server_image", default="us-docker.pkg.dev/cloud-tpu-v2-images/pathways/server:latest", help="Pathways server image")
  parser.add_argument("--pathways_proxy_server_image", default="us-docker.pkg.dev/cloud-tpu-v2-images/pathways/proxy_server:latest", help="Pathways proxy server image")
  parser.add_argument("--pathways_gcs_scratch_location", default="gs://cloud-pathways-staging/tmp", help="GCS scratch location")

  parser.add_argument("--worker_container_name", default="main", help="Name of the worker container")
  parser.add_argument("--worker_container_image", default="python:3.12", help="Image of the worker container")
  parser.add_argument("--worker_container_port", type=int, default=12345, help="gRPC port of the worker container")
  parser.add_argument("--worker_startup_command", default="sleep infinity", help="Command to run on startup")
