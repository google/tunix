...
def main():
  ...
  has_attr = hasattr(model_lib, "_SPLASH_SEGMENT_TEMPLATE")
  ...
  if args.expect == "on":
    model_lib.set_splash_segment_template((1024, 1024))
    print(f"template set -> {model_lib._SPLASH_SEGMENT_TEMPLATE}")
  elif has_attr and model_lib._SPLASH_SEGMENT_TEMPLATE is not None:
