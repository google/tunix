...
# ====== Sharding ======
MESH = [(2, 4), ("fsdp", "tp")]
ROLLOUT_MESH = [(1, 2), ("fsdp", "tp")]  # original: 4,1
TRAINER_MESH = [(2, 1), ("fsdp", "tp")]  # original: 2,2
...
if NOTEBOOK_ENV == "g3":
  ...
  DATA_PATH_PREFIX = "gs://aolemila/rl/data"
  MODEL_PATH_PREFIX = "gs://aolemila/rl/models"
  CKPT_DIR_PREFIX = "gs://aolemila/rl/checkpoints"
...
if TRAIN_WITH_LORA:
  ...
  qwen2_actor = params_lib.create_model_from_safe_tensors(
      MODEL_PATH, config, trainer_mesh, dtype=jnp.bfloat16  # jnp.float32
  )
...
# %%
print(f"=================begin to train=====================", flush=True)
grpo_trainer.train(train_dataset)
print(f"=================complete to train=====================", flush=True)
