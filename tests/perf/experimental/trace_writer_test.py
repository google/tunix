...
class PerfettoTraceWriterTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      (
          "rollout_with_prompt_id_and_group_index",
          perf_constants.ROLLOUT,
          {
              perf_constants.PROMPT_ID: 5,
              perf_constants.GROUP_INDEX: 3,
              perf_constants.STEP: 100,
          },
          "rollout (step=100, prompt_id=5, group_index=3)",
      ),
      (
          "rollout_with_missing_group_index",
          perf_constants.ROLLOUT,
          {perf_constants.PROMPT_ID: 5},
          "rollout (prompt_id=5)",
      ),
      (
          "environment_with_prompt_id_and_group_index",
          ...
          "environment (step=100, prompt_id=5, group_index=3)",
      ),
      (
          "environment_with_missing_group_index",
          perf_constants.ENVIRONMENT,
          {perf_constants.PROMPT_ID: 5},
          "environment (prompt_id=5)",
      ),
      (
