      ...
      with mock.patch.object(
        ...
        with mock.patch.object(
          ...
          with mock.patch.object(
              pipeline,
              "_load_raw_dataset",
              return_value=(mock.sentinel.raw_dataset, None),
          ):
            with mock.patch.object(
                ppo_main.data_lib,
                "post_init_dataset",
              ...
              with mock.patch.object(
                ...
                with mock.patch(
                  ...
                  pipeline._run(mode="ppo")

    rl_config = pipeline._mutable_config_mapping("rl_training_config")
    self.assertEqual(rl_config.get("max_steps"), 1)
    self.assertEqual(rl_config["actor_optimizer_config"].get("decay_steps"), 1)
    self.assertEqual(rl_config["critic_optimizer_config"].get("decay_steps"), 1)
