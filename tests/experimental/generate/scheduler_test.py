...
class ScheduleStepTest(parameterized.TestCase):
  ...
  def test_queue_new_requests(self):
    req = request_lib.Request(req_id="r1", prompt_token_ids=[10, 20, 30])
  ...
  def test_schedule_step_chunked_prefill(self):
    ...
    req = request_lib.Request(req_id="r1", prompt_token_ids=prompt)
  ...
  def test_schedule_step_orders_decodes_then_chunked_then_prefills(self):
    prefill = request_lib.Request(req_id="p", prompt_token_ids=[10, 20, 30])
    chunked = request_lib.Request(req_id="c", prompt_token_ids=list(range(32)))
    decode = request_lib.Request(req_id="d", prompt_token_ids=[42])
  ...
  def test_token_budget_exhaustion(self):
    ...
    req1 = request_lib.Request(req_id="r1", prompt_token_ids=list(range(8)))
    req2 = request_lib.Request(req_id="r2", prompt_token_ids=list(range(100, 112)))
