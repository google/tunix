...
class VlDpoTrainerTest(parameterized.TestCase):
    ...
    def test_vl_dpo_trainer(
        ...
        for metric_name in [
            ...
            self.assertLen(
                vl_dpo_trainer.metrics_logger.get_metric_history(metric_name, "train"),
    ...
    def test_vl_dpo_prepare_inputs(self):
        ...
        self.assertEqual(out.images.shape, (4, 3, 224, 224))  # Check image duplication
    ...
    def test_vl_dpo_vs_dpo_no_images(self):
        ...
        np.testing.assert_array_equal(dpo_out.attention_mask, vl_dpo_out.attention_mask)
